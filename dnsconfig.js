...
D("southamptoncityscouts.co.uk", REG_NONE,
    ...
    // Google Workspace
    GoogleWorkspaceRecordsWithServices("8BcNZ26MXsKzFRg3O8rXUG4bpeeFxxEPb4o7PVaV174", "legacy", "workspace_only"),
);
...
D("woodmill.org.uk", REG_NONE,
    ...
    // Google Workspace
    GoogleWorkspaceRecords("rvtFceqW7Xlvkcj9lrc60v5RKQt5ZGT06VLMa73gAm4", "google_apps", "workspace_only"),
);
...
D("woodmill.co.uk", REG_NONE,
    ...
    GoogleWorkspaceRecords("KKYq5rmA66K87P57Rhi0UHNQYNJScnue8AY53RXlELA", "google_apps", "receive_only"),
);
...
D("25th-southampton.org.uk", REG_NONE,
    ...
    GoogleWorkspaceRecords("PiUAKlFrHWE-JB4ltgMf7l9oP_Jj36zSXnbaPA2dwII", "legacy", "workspace_only"),
);
...
D("highfieldscouts.org.uk", REG_NONE,
    ...
    GoogleWorkspaceRecords("lCPO8h-KZRF0k0GHown5PhVDFf_z6MSWIDBVwrtju9c", "legacy", "workspace_only"),
)
